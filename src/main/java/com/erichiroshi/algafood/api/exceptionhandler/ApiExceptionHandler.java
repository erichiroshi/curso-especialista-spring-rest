...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
		...
		String detail = "Ocorreu um erro interno inesperado no sistema. Tente novamente e"
	...
	public ResponseEntity<?> handlerNegocio(NegocioException ex, WebRequest request) {
